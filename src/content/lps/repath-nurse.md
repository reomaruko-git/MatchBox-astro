...
images:
  ...
  mvAlt: "スマートフォンで落ち着いて求人を見る看護師"
  og: "../../assets/images/lp/repath-nurse/ogp.png"
colors:
  primary: "#0F4C81"
  accent: "#FF8C00"
rankings: []
canonical: "https://match-box.net/repath-nurse/"
keywords:
  - text: "リーパスナース"
...
## 「登録直後の電話ラッシュ」に疲弊していませんか？

「求人を見たかっただけなのに、電話が鳴り止まない」。<br>
「夜勤明けに何度も着信が入っていて、休まらない」。

多くの看護師が、自分のペースで進められない転職活動に悩んでいます。<br>
希望条件をじっくり検討できないまま面接に進むことは、理想のキャリアとは言えません。

<div class="my-8">
  <a href="/link/repath-nurse/" class="text-primary font-bold underline underline-offset-4 decoration-primary/40 hover:decoration-primary transition-all">
    >> 電話連絡なし。LINEで完結する「リーパスナース」の詳細を見る
  </a>
</div>
...
* <span class="font-bold text-primary">訪問看護・在宅医療へ興味:</span> 未経験だが、今後のキャリアとして在宅分野を検討している方。
* <span class="font-bold text-primary">ブランクからの復職:</span> 臨床現場を離れていたが、無理のない範囲で復帰を考えている方。

まずは求人の内容を確認するだけでも構いません。
<div class="my-10 text-left">
  <a href="/link/repath-nurse/" class="text-primary font-bold underline underline-offset-4 decoration-primary/40 hover:decoration-primary transition-all text-xl">
    >> 無料で非公開求人をLINEで受け取る
  </a>
  <p class="text-center text-xs mt-3 text-slate-500">※個人情報は厳重に管理され、無理な勧誘は行いません。</p>
</div>
<img src="https://www.rentracks.jp/adx/p.gifx?idx=0.71657.374964.10190.14550&dna=166734" border="0" height="1" width="1">